...
- `pkg test statistics` to run a test suite for all 453 [^1] functions and class definitions currently available and ensure that they work properly on your system.
