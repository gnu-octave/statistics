...
## nbinpdf, ncfpdf, nctpdf, ncx2pdf, normpdf, poisspdf, raylpdf, ricepdf, tpdf,
## tlspdf, tripdf, unidpdf, unifpdf, vmpdf, wblpdf}
## @end deftypefn
...
%!shared x
%! x = [1:5];
%!assert_equal (pdf ('Beta', x, 5, 2), betapdf (x, 5, 2))
%!assert_equal (pdf ('beta', x, 5, 2), betapdf (x, 5, 2))
%!assert_equal (pdf ('Binomial', x, 5, 2), binopdf (x, 5, 2))
%!assert_equal (pdf ('bino', x, 5, 2), binopdf (x, 5, 2))
%!assert_equal (pdf ('Birnbaum-Saunders', x, 5, 2), bisapdf (x, 5, 2))
%!assert_equal (pdf ('bisa', x, 5, 2), bisapdf (x, 5, 2))
%!assert_equal (pdf ('Burr', x, 5, 2, 2), burrpdf (x, 5, 2, 2))
%!assert_equal (pdf ('burr', x, 5, 2, 2), burrpdf (x, 5, 2, 2))
%!assert_equal (pdf ('Cauchy', x, 5, 2), cauchypdf (x, 5, 2))
%!assert_equal (pdf ('cauchy', x, 5, 2), cauchypdf (x, 5, 2))
%!assert_equal (pdf ('Chi-squared', x, 5), chi2pdf (x, 5))
%!assert_equal (pdf ('chi2', x, 5), chi2pdf (x, 5))
%!assert_equal (pdf ('Extreme Value', x, 5, 2), evpdf (x, 5, 2))
%!assert_equal (pdf ('ev', x, 5, 2), evpdf (x, 5, 2))
%!assert_equal (pdf ('Exponential', x, 5), exppdf (x, 5))
%!assert_equal (pdf ('exp', x, 5), exppdf (x, 5))
%!assert_equal (pdf ('F-Distribution', x, 5, 2), fpdf (x, 5, 2))
%!assert_equal (pdf ('f', x, 5, 2), fpdf (x, 5, 2))
%!assert_equal (pdf ('Gamma', x, 5, 2), gampdf (x, 5, 2))
%!assert_equal (pdf ('gam', x, 5, 2), gampdf (x, 5, 2))
%!assert_equal (pdf ('Geometric', x, 5), geopdf (x, 5))
%!assert_equal (pdf ('geo', x, 5), geopdf (x, 5))
%!assert_equal (pdf ('Generalized Extreme Value', x, 5, 2, 2), gevpdf (x, 5, 2, 2))
%!assert_equal (pdf ('gev', x, 5, 2, 2), gevpdf (x, 5, 2, 2))
%!assert_equal (pdf ('Generalized Pareto', x, 5, 2, 2), gppdf (x, 5, 2, 2))
%!assert_equal (pdf ('gp', x, 5, 2, 2), gppdf (x, 5, 2, 2))
%!assert_equal (pdf ('Gumbel', x, 5, 2), gumbelpdf (x, 5, 2))
%!assert_equal (pdf ('gumbel', x, 5, 2), gumbelpdf (x, 5, 2))
%!assert_equal (pdf ('Half-normal', x, 5, 2), hnpdf (x, 5, 2))
%!assert_equal (pdf ('hn', x, 5, 2), hnpdf (x, 5, 2))
%!assert_equal (pdf ('Hypergeometric', x, 5, 2, 2), hygepdf (x, 5, 2, 2))
%!assert_equal (pdf ('hyge', x, 5, 2, 2), hygepdf (x, 5, 2, 2))
%!assert_equal (pdf ('Inverse Gaussian', x, 5, 2), invgpdf (x, 5, 2))
%!assert_equal (pdf ('invg', x, 5, 2), invgpdf (x, 5, 2))
%!assert_equal (pdf ('Laplace', x, 5, 2), laplacepdf (x, 5, 2))
%!assert_equal (pdf ('laplace', x, 5, 2), laplacepdf (x, 5, 2))
%!assert_equal (pdf ('Logistic', x, 5, 2), logipdf (x, 5, 2))
%!assert_equal (pdf ('logi', x, 5, 2), logipdf (x, 5, 2))
%!assert_equal (pdf ('Log-Logistic', x, 5, 2), loglpdf (x, 5, 2))
%!assert_equal (pdf ('logl', x, 5, 2), loglpdf (x, 5, 2))
%!assert_equal (pdf ('Lognormal', x, 5, 2), lognpdf (x, 5, 2))
%!assert_equal (pdf ('logn', x, 5, 2), lognpdf (x, 5, 2))
%!assert_equal (pdf ('Nakagami', x, 5, 2), nakapdf (x, 5, 2))
%!assert_equal (pdf ('naka', x, 5, 2), nakapdf (x, 5, 2))
%!assert_equal (pdf ('Negative Binomial', x, 5, 2), nbinpdf (x, 5, 2))
%!assert_equal (pdf ('nbin', x, 5, 2), nbinpdf (x, 5, 2))
%!assert_equal (pdf ('Noncentral F-Distribution', x, 5, 2, 2), ncfpdf (x, 5, 2, 2))
%!assert_equal (pdf ('ncf', x, 5, 2, 2), ncfpdf (x, 5, 2, 2))
%!assert_equal (pdf ('Noncentral Student T', x, 5, 2), nctpdf (x, 5, 2))
%!assert_equal (pdf ('nct', x, 5, 2), nctpdf (x, 5, 2))
%!assert_equal (pdf ('Noncentral Chi-Squared', x, 5, 2), ncx2pdf (x, 5, 2))
%!assert_equal (pdf ('ncx2', x, 5, 2), ncx2pdf (x, 5, 2))
%!assert_equal (pdf ('Normal', x, 5, 2), normpdf (x, 5, 2))
%!assert_equal (pdf ('norm', x, 5, 2), normpdf (x, 5, 2))
%!assert_equal (pdf ('Poisson', x, 5), poisspdf (x, 5))
%!assert_equal (pdf ('poiss', x, 5), poisspdf (x, 5))
%!assert_equal (pdf ('Rayleigh', x, 5), raylpdf (x, 5))
%!assert_equal (pdf ('rayl', x, 5), raylpdf (x, 5))
%!assert_equal (pdf ('Rician', x, 5, 1), ricepdf (x, 5, 1))
%!assert_equal (pdf ('rice', x, 5, 1), ricepdf (x, 5, 1))
%!assert_equal (pdf ('Student T', x, 5), tpdf (x, 5))
%!assert_equal (pdf ('t', x, 5), tpdf (x, 5))
%!assert_equal (pdf ('location-scale T', x, 5, 1, 2), tlspdf (x, 5, 1, 2))
%!assert_equal (pdf ('tls', x, 5, 1, 2), tlspdf (x, 5, 1, 2))
%!assert_equal (pdf ('Triangular', x, 5, 2, 2), tripdf (x, 5, 2, 2))
%!assert_equal (pdf ('tri', x, 5, 2, 2), tripdf (x, 5, 2, 2))
%!assert_equal (pdf ('Discrete Uniform', x, 5), unidpdf (x, 5))
%!assert_equal (pdf ('unid', x, 5), unidpdf (x, 5))
%!assert_equal (pdf ('Uniform', x, 5, 2), unifpdf (x, 5, 2))
%!assert_equal (pdf ('unif', x, 5, 2), unifpdf (x, 5, 2))
%!assert_equal (pdf ('Von Mises', x, 5, 2), vmpdf (x, 5, 2))
%!assert_equal (pdf ('vm', x, 5, 2), vmpdf (x, 5, 2))
%!assert_equal (pdf ('Weibull', x, 5, 2), wblpdf (x, 5, 2))
