...
%! assert (idx, [[3, 48, 4]; [4, 48, 30]; [5, 38, 1]; [6, 19, 11];
%!              [7, 48, 3]; [8, 40, 50]; [9, 39, 4]])
%! assert (D, [[0, 0.1414, 0.2449]; [0, 0.1414, 0.1732]; [0, 0.1414, 0.1414];
%!            [0, 0.3317, 0.3464]; [0, 0.2236, 0.2646]; [0, 0.1000, 0.1414];
%!            [0, 0.1414, 0.3000]], 5e-5)
