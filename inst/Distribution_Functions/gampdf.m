...
function y = gampdf (x, a, b)
  ...
  if (! (isfloat (x) && isfloat (a) && isfloat (b)))
    error ("gampdf: X, A, and B must be double or single.");
  endif
...
%!error<gampdf: X, A, and B must be double or single.> gampdf (int32 (2), 2, 2)
%!error<gampdf: X, A, and B must be double or single.> gampdf (true, 2, 2)
%!error<gampdf: X, A, and B must be double or single.> gampdf ('a', 2, 2)
