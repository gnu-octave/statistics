...
## -*- texinfo -*-
## @deftypefn {Function File} @var{n} = sampsizepwr (@var{testtype}, @var{params}, @var{p1})
## @deftypefnx {Function File} @var{n} = sampsizepwr (@var{testtype}, @var{params}, @var{p1}, @var{power})
## @deftypefnx {Function File} @var{power} = sampsizepwr (@var{testtype}, @var{params}, @var{p1}, [], @var{n})
## @deftypefnx {Function File} @var{p1} = sampsizepwr (@var{testtype}, @var{params}, [], @var{power}, @var{n})
## @deftypefnx {Function File} [@var{n1}, @var{n2}] = sampsizepwr ("t2", @var{params}, @var{p1}, @var{power})
## @deftypefnx {Function File} [@dots{}] = sampsizepwr (@var{testtype}, @var{params}, @var{p1}, @var{power}, @var{n}, @var{name}, @var{value})
##
