...
%!error<ClassificationKNN: ClassificationKNN: ClassNames must be a cellstring array.> ...
%! ClassificationKNN(ones (5,2), ones (5,1), "ClassNames", 1)
%!error<ClassificationKNN: ClassificationKNN: ClassNames must be a cellstring array.> ...
%! ClassificationKNN(ones (5,2), ones (5,1), "ClassNames", ["1"])
%!error<ClassificationKNN: ClassificationKNN: not all ClassNames are present in Y.> ...
