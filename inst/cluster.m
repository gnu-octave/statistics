...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{T} =} cluster (@var{Z},'Cutoff', @var{C})
## @deftypefnx {Function File} @
##   {@var{T} =} cluster (@var{Z}, 'Cutoff', @var{C}, 'Depth', @var{D})
## @deftypefnx {Function File} @
##   {@var{T} =} cluster (@var{Z}, 'Cutoff', @var{C}, 'Criterion', @var{criterion})
## @deftypefnx {Function File} @
##   {@var{T} =} cluster (@var{Z}, 'MaxClust', @var{N})
##
