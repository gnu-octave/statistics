...
classdef tLocationScaleDistribution
  ...
  methods(Access = public)
    ...
    ## @deftypefnx {tLocationScaleDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {tLocationScaleDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
