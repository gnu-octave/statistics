...
classdef LogisticDistribution
  ...
  properties(Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} sigma
    ##
    ## Scale parameter
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LogisticDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {LogisticDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## @deftypefnx {LogisticDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {LogisticDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {LogisticDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {LogisticDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {LogisticDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {LogisticDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
