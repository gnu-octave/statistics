...
classdef BinomialDistribution
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {BinomialDistribution} {@var{p} =} icdf (@var{pd}, @var{p})
    ##
    ## Compute the cumulative distribution function (CDF).
    ##
...
%!error <BinomialDistribution: N must be a positive integer scalar.> ...
%! BinomialDistribution(Inf, 1)
%!error <BinomialDistribution: N must be a positive integer scalar.> ...
%! BinomialDistribution(i, 1)
%!error <BinomialDistribution: N must be a positive integer scalar.> ...
%! BinomialDistribution("a", 1)
%!error <BinomialDistribution: N must be a positive integer scalar.> ...
%! BinomialDistribution([1, 2], 1)
%!error <BinomialDistribution: N must be a positive integer scalar.> ...
%! BinomialDistribution(NaN, 1)
%!error <BinomialDistribution: p must be a real scalar bounded in the range> ...
%! BinomialDistribution(1, 0)
%!error <BinomialDistribution: p must be a real scalar bounded in the range> ...
%! BinomialDistribution(1, -1)
%!error <BinomialDistribution: p must be a real scalar bounded in the range> ...
