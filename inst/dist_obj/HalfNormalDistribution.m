...
classdef HalfNormalDistribution
  ...
  ## @item Use the constructor @qcode{HalfNormalDistribution (@var{mu}, @var{sigma})}
  ...
  ## @var{mu}, @var{freq})} to a distribution to data @var{x}.
  ## @end itemize
  ##
  ...
  ##
  ## A @code{HalfNormalDistribution} object contains the following properties,
  ...
  ## @end multitable
  ##
  ## A @code{HalfNormalDistribution} object contains the following methods:
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {HalfNormalDistribution} {@var{p} =} icdf (@var{pd}, @var{p})
    ##
    ## Compute the cumulative distribution function (CDF).
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {HalfNormalDistribution} {@var{y} =} random (@var{pd})
    ## @deftypefnx {HalfNormalDistribution} {@var{y} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {HalfNormalDistribution} {@var{y} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {HalfNormalDistribution} {@var{y} =} random (@var{pd}, [@var{sz}])
    ##
...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), ...
...
%! proflik (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), {1})
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), 1)
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), 2, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (HalfNormalDistribution.fit (hnrnd (1, 1, [1, 100]), 1), 2, ...
%! "Display")
