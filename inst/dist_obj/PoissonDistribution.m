...
classdef PoissonDistribution
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {PoissonDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {} plot (@var{pd})
    ## @deftypefnx {PoissonDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {PoissonDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    function r = random (this, varargin)
      ...
      if (this.IsTruncated)
        ...
        lx = this.Truncation(1);
        ux = this.Truncation(2);
        ratio = 1 / diff (poisscdf ([ux, lx], this.nu, this.sigma));
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {PoissonDistribution} {@var{v} =} var (@var{pd})
    ##
...
function checkparams (lambda)
  if (! (isscalar (lambda) && isnumeric (lambda) && isreal (lambda)
    ...
    error ("PoissonDistribution: LAMBDA must be a positive integer scalar.")
  endif
endfunction
...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), ...
%! "parameter", "lambda", "alpha", {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), ...
%! "parameter", {"lambda", "param"})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), ...
%! "alpha", 0.01, "parameter", {"lambda", "param"})
...
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (PoissonDistribution.fit (poissrnd (1, [1, 100])), ...
%! "alpha", 0.01, "parameter", "lambda", "NAME", "value")
...
%! proflik (PoissonDistribution.fit (poissrnd (1, [1, 100])), 3)
%!error <proflik: PNUM must be a scalar number indexing a valid parameter.> ...
%! proflik (PoissonDistribution.fit (poissrnd (1, [1, 100])), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a valid parameter.> ...
%! proflik (PoissonDistribution.fit (poissrnd (1, [1, 100])), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (PoissonDistribution.fit (poissrnd (1, [1, 100])), 1, ones (2))
