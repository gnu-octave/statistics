...
classdef NegativeBinomialDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} NegativeBinomialDistribution
  ##
  ...
  properties (Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} P
    ##
  ...
  properties (GetAccess = public, Constant = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
  ...
  properties (GetAccess = public, SetAccess = protected)
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NegativeBinomialDistribution} {property} InputData
    ##
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {NegativeBinomialDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {NegativeBinomialDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {NegativeBinomialDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {NegativeBinomialDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {NegativeBinomialDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
