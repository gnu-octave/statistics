...
classdef GeneralizedExtremeValueDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.GeneralizedExtremeValueDistribution
  ##
  ...
  ## @code{prob.GeneralizedExtremeValueDistribution} object.
  ##
  ## @itemize
  ...
  ## @item Use the constructor @qcode{prob.GeneralizedExtremeValueDistribution
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} k
    ##
    ## Shape parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} sigma
    ##
    ## Scale parameter
    ##
    ## A positive scalar value characterizing the scale of the generalized
    ## extreme value distribution. You can access the @qcode{sigma} property
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} mu
    ##
    ## Location parameter
    ##
    ## A scalar value characterizing the location of the generalized extreme
    ## value distribution. You can access the @qcode{mu} property using dot name
    ## assignment.
    ##
    ## @end deftp
    mu
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.GeneralizedExtremeValueDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.GeneralizedExtremeValueDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.GeneralizedExtremeValueDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.GeneralizedExtremeValueDistribution.makeFitted ...
...
## Test output
%!shared pd, t
%! pd = prob.GeneralizedExtremeValueDistribution;
%! t = truncate (pd, 2, 4);
...
%! x = [0.3; -1.2; 0.8; 1.5; -0.4; 0.2; -0.9; 1.1; 0.6; -0.3; ...
...
## 'prob.GeneralizedExtremeValueDistribution' constructor
%!error <GeneralizedExtremeValueDistribution: K must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (Inf, 1, 1)
%!error <GeneralizedExtremeValueDistribution: K must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (i, 1, 1)
%!error <GeneralizedExtremeValueDistribution: K must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution ('a', 1, 1)
%!error <GeneralizedExtremeValueDistribution: K must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution ([1, 2], 1, 1)
%!error <GeneralizedExtremeValueDistribution: K must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (NaN, 1, 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 0, 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, -1, 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, Inf, 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, i, 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 'a', 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, [1, 2], 1)
%!error <GeneralizedExtremeValueDistribution: SIGMA must be a positive real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, NaN, 1)
%!error <GeneralizedExtremeValueDistribution: MU must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 1, Inf)
%!error <GeneralizedExtremeValueDistribution: MU must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 1, i)
%!error <GeneralizedExtremeValueDistribution: MU must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 1, 'a')
%!error <GeneralizedExtremeValueDistribution: MU must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 1, [1, 2])
%!error <GeneralizedExtremeValueDistribution: MU must be a real scalar.> ...
%! prob.GeneralizedExtremeValueDistribution (1, 1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.GeneralizedExtremeValueDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.GeneralizedExtremeValueDistribution, 2, 3)

## 'paramci' method
%!shared x
%! x = gevrnd (1, 1, 1, [1, 100]);
%!error <paramci: optional arguments must be in NAME-VALUE pairs.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), ...
%!          'parameter', 'sigma', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), ...
%!          'parameter', {'k', 'sigma', 'mu', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'k', 'sigma', 'mu', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.GeneralizedExtremeValueDistribution.fit (x), 'alpha', 0.01, ...
%!          'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
...
%! plot (prob.GeneralizedExtremeValueDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.GeneralizedExtremeValueDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 4)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, ...
%!          'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.GeneralizedExtremeValueDistribution.fit (x), 1, {[1 2 3 4]}, ...
%!          'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.GeneralizedExtremeValueDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.GeneralizedExtremeValueDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.GeneralizedExtremeValueDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.GeneralizedExtremeValueDistribution (1, 1, 1);
%! pd(2) = prob.GeneralizedExtremeValueDistribution (1, 3, 1);
