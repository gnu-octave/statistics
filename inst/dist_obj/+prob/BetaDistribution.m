...
classdef BetaDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.BetaDistribution
  ##
  ## Beta probability distribution object.
  ##
  ## A @code{prob.BetaDistribution} object consists of parameters, a model
  ...
  ##
  ## There are several ways to create a @code{prob.BetaDistribution} object.
  ##
  ## @itemize
  ...
  ## @item Use the constructor @qcode{prob.BetaDistribution (@var{a}, @var{b})}
  ## to create a beta distribution with fixed parameter values @var{a} and
  ## @var{b}.
  ## @item Use the static method @qcode{prob.BetaDistribution.fit (@var{x},
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} a
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} b
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BetaDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.BetaDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.BetaDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.BetaDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.BetaDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.BetaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.BetaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.BetaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.BetaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.BetaDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.BetaDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.BetaDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.BetaDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BetaDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.BetaDistribution.makeFitted (phat, pci, acov, x, freq);
    endfunction
...
## 'prob.BetaDistribution' constructor
%!error <BetaDistribution: A must be a positive real scalar.> ...
%! prob.BetaDistribution (0, 1)
%!error <BetaDistribution: A must be a positive real scalar.> ...
%! prob.BetaDistribution (Inf, 1)
%!error <BetaDistribution: A must be a positive real scalar.> ...
%! prob.BetaDistribution (i, 1)
%!error <BetaDistribution: A must be a positive real scalar.> ...
%! prob.BetaDistribution ('a', 1)
%!error <BetaDistribution: A must be a positive real scalar.> ...
%! prob.BetaDistribution ([1, 2], 1)
%!error <BetaDistribution: A must be a positive real scalar.> ...
%! prob.BetaDistribution (NaN, 1)
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, 0)
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, -1)
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, Inf)
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, i)
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, 'a')
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, [1, 2])
%!error <BetaDistribution: B must be a positive real scalar.> ...
%! prob.BetaDistribution (1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.BetaDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.BetaDistribution, 2, 3)
...
%! paramci (prob.BetaDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'parameter', 'a', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'parameter', {'a', 'b', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'a', 'b', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.BetaDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', 0.01, 'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', 0.01, 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BetaDistribution.fit (x), 'alpha', 0.01, 'parameter', 'a', ...
%!          'NAME', 'value')

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.BetaDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.BetaDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.BetaDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.BetaDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BetaDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BetaDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BetaDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.BetaDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.BetaDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.BetaDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.BetaDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.BetaDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BetaDistribution.fit (x), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BetaDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BetaDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.BetaDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.BetaDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.BetaDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.BetaDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.BetaDistribution (1, 1);
%! pd(2) = prob.BetaDistribution (1, 3);
