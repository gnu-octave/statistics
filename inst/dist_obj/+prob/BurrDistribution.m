...
classdef BurrDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.BurrDistribution
  ##
  ## Burr probability distribution object.
  ##
  ## A @code{prob.BurrDistribution} object consists of parameters, a model
  ...
  ## @var{c} and @var{k}.
  ##
  ## There are several ways to create a @code{prob.BurrDistribution} object.
  ##
  ## @itemize
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} alpha
    ##
    ## Scale parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} c
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} k
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BurrDistribution} {property} ParameterIsFixed
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.BurrDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.BurrDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.BurrDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.BurrDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.BurrDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.BurrDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.BurrDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.BurrDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.BurrDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.BurrDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.BurrDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.BurrDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BurrDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.BurrDistribution.makeFitted (phat, pci, acov, x, censor, freq);
    endfunction
...
## 'prob.BurrDistribution' constructor
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution (0, 1, 1)
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution (-1, 1, 1)
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution (Inf, 1, 1)
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution (i, 1, 1)
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution ('a', 1, 1)
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution ([1, 2], 1, 1)
%!error <BurrDistribution: ALPHA must be a positive real scalar.> ...
%! prob.BurrDistribution (NaN, 1, 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 0, 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, -1, 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, Inf, 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, i, 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 'a', 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, [1, 2], 1)
%!error <BurrDistribution: C must be a positive real scalar.> ...
%! prob.BurrDistribution (1, NaN, 1)
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, 0)
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, -1)
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, Inf)
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, i)
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, 'a')
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, [1, 2])
%!error <BurrDistribution: K must be a positive real scalar.> ...
%! prob.BurrDistribution (1, 1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.BurrDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.BurrDistribution, 2, 3)
...
%! paramci (prob.BurrDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'parameter', 'c', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'parameter', {'alpha', 'c', 'k', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'alpha', 'c', 'k', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.BurrDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', 0.01, 'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', 0.01, 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BurrDistribution.fit (x), 'alpha', 0.01, 'parameter', 'c', ...
%!          'NAME', 'value')

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.BurrDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.BurrDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.BurrDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.BurrDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BurrDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BurrDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BurrDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.BurrDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.BurrDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.BurrDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.BurrDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.BurrDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BurrDistribution.fit (x), 4)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BurrDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BurrDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.BurrDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.BurrDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.BurrDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.BurrDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.BurrDistribution (1, 1, 1);
%! pd(2) = prob.BurrDistribution (1, 3, 1);
