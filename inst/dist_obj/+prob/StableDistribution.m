...
classdef StableDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.StableDistribution
  ##
  ## Stable probability distribution object.
  ##
  ## A @code{prob.StableDistribution} object consists of parameters, a model
  ...
  ##
  ## There are several ways to create a @code{prob.StableDistribution} object.
  ##
  ## @itemize
  ...
  ## @item Use the constructor @qcode{prob.StableDistribution (@var{alpha},
  ...
  ## @item Use the static method @qcode{prob.StableDistribution.fit (@var{x},
  ...
  properties (Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} alpha
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} beta
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} gam
    ##
    ## Scale parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} delta
    ##
    ## Location parameter
    ##
  ...
  properties (GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} ParameterDescription
    ##
  ...
  properties (GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.StableDistribution} {property} ParameterValues
    ##
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.StableDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{"upper"})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.StableDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.StableDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.StableDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.StableDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.StableDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.StableDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.StableDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.StableDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.StableDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.StableDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.StableDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.StableDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods (Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.StableDistribution.makeFitted (phat, pci, acov, x, freq);
    endfunction
...
%!error <StableDistribution: ALPHA must be a real scalar in \(0, 2\].> ...
%! prob.StableDistribution (2.5, 0, 1, 0)
%!error <StableDistribution: BETA must be a real scalar in \[-1, 1\].> ...
%! prob.StableDistribution (1.5, 2, 1, 0)
%!error <StableDistribution: GAM must be a positive real scalar.> ...
%! prob.StableDistribution (1.5, 0, 0, 0)
%!error <StableDistribution: DELTA must be a real scalar.> ...
%! prob.StableDistribution (1.5, 0, 1, Inf)
%!error <cdf: requires a scalar probability distribution.> ...
%! cdf ([pd, pd], 1)
