...
classdef tLocationScaleDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.tLocationScaleDistribution
  ##
  ...
  ##
  ## There are several ways to create a @code{prob.tLocationScaleDistribution}
  ## object.
  ##
  ## @itemize
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} mu
    ##
    ## Location parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} sigma
    ##
    ## Scale parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} nu
    ##
    ## Degrees of freedom
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.tLocationScaleDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.tLocationScaleDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.tLocationScaleDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.tLocationScaleDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.tLocationScaleDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.tLocationScaleDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.tLocationScaleDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.tLocationScaleDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.tLocationScaleDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.tLocationScaleDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.tLocationScaleDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.tLocationScaleDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.tLocationScaleDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    function r = random (this, varargin)
      ...
      if (this.IsTruncated)
        ...
        lx = this.Truncation(1);
        ux = this.Truncation(2);
        ratio = 1 / diff (tlscdf ([lx, ux], this.mu, this.sigma, this.nu));
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.tLocationScaleDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.tLocationScaleDistribution.makeFitted ...
    ...
    function pd = makeFitted (phat, pci, acov, x, censor, freq)
      ...
      sigma = phat(2);
      nu = phat(3);
      pd = prob.tLocationScaleDistribution (mu, sigma, nu);
      pd.ParameterCI = pci;
...
## Test output
%!shared pd, t
%! pd = prob.tLocationScaleDistribution;
%! t = truncate (pd, 2, 4);
...
## 'prob.tLocationScaleDistribution' constructor
%!error <tLocationScaleDistribution: MU must be a real scalar.> ...
%! prob.tLocationScaleDistribution (i, 1, 1)
%!error <tLocationScaleDistribution: MU must be a real scalar.> ...
%! prob.tLocationScaleDistribution (Inf, 1, 1)
%!error <tLocationScaleDistribution: MU must be a real scalar.> ...
%! prob.tLocationScaleDistribution ([1, 2], 1, 1)
%!error <tLocationScaleDistribution: MU must be a real scalar.> ...
%! prob.tLocationScaleDistribution ('a', 1, 1)
%!error <tLocationScaleDistribution: MU must be a real scalar.> ...
%! prob.tLocationScaleDistribution (NaN, 1, 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 0, 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, -1, 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, Inf, 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, i, 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 'a', 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, [1, 2], 1)
%!error <tLocationScaleDistribution: SIGMA must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, NaN, 1)
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, 0)
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, -1)
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, Inf)
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, i)
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, 'a')
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, [1, 2])
%!error <tLocationScaleDistribution: NU must be a positive real scalar.> ...
%! prob.tLocationScaleDistribution (0, 1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.tLocationScaleDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.tLocationScaleDistribution, 2, 3)

## 'paramci' method
%!shared x
%! x = tlsrnd (0, 1, 1, [1, 100]);
%!error <paramci: optional arguments must be in NAME-VALUE pairs.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'parameter', 'mu', ...
%!          'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), ...
%!          'parameter', {'mu', 'sigma', 'nu', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'mu', 'sigma', 'nu', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', 0.01, 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.tLocationScaleDistribution.fit (x), 'alpha', 0.01, ...
...
%! plot (prob.tLocationScaleDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.tLocationScaleDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.tLocationScaleDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.tLocationScaleDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.tLocationScaleDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 4)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.tLocationScaleDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.tLocationScaleDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.tLocationScaleDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.tLocationScaleDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.tLocationScaleDistribution (0, 1, 1);
%! pd(2) = prob.tLocationScaleDistribution (0, 1, 3);
