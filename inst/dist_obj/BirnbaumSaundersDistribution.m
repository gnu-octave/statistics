...
classdef BirnbaumSaundersDistribution
  ...
  methods(Access = public)
    ...
    ## @deftypefnx {BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
