...
classdef NormalDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} NormalDistribution
  ##
  ...
  properties (Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} sigma
    ##
    ## Scale parameter
    ##
  ...
  properties (GetAccess = public, Constant = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
  ...
  properties (GetAccess = public, SetAccess = protected)
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {NormalDistribution} {property} InputData
    ##
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {NormalDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {NormalDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {NormalDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {NormalDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {NormalDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
