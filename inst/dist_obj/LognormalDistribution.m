...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), ...
...
%! proflik (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (LognormalDistribution.fit (lognrnd (1, 1, [1, 100])), 1, ones (2))
