...
classdef LognormalDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} LognormalDistribution
  ##
  ...
  ## @item Use the constructor @qcode{LognormalDistribution (@var{mu},
  ...
  properties (Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} sigma
    ##
  ...
  properties (GetAccess = public, Constant = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
  ...
  properties (GetAccess = public, SetAccess = protected)
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {LognormalDistribution} {property} InputData
    ##
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {LognormalDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {LognormalDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {LognormalDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {LognormalDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {LognormalDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
