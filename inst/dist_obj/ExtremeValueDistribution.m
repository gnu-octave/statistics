...
classdef ExtremeValueDistribution
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## @deftypefnx {ExtremeValueDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {ExtremeValueDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {ExtremeValueDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {ExtremeValueDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {ExtremeValueDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
