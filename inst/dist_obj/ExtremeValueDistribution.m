...
classdef ExtremeValueDistribution
  ...
  ##
  ## A @code{ExtremeValueDistribution} object consists of parameters, a model
  ...
  ##
  ## A @code{ExtremeValueDistribution} object contains the following properties,
  ...
  ## @end multitable
  ##
  ## A @code{ExtremeValueDistribution} object contains the following methods:
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{p} =} icdf (@var{pd}, @var{p})
    ##
    ## Compute the cumulative distribution function (CDF).
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {ExtremeValueDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {} plot (@var{pd})
    ## @deftypefnx {ExtremeValueDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {ExtremeValueDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{y} =} random (@var{pd})
    ## @deftypefnx {ExtremeValueDistribution} {@var{y} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {ExtremeValueDistribution} {@var{y} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {ExtremeValueDistribution} {@var{y} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {ExtremeValueDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods (Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = ExtremeValueDistribution.makeFitted ...
...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), ...
...
%! proflik (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (ExtremeValueDistribution.fit (evrnd (1, 1, [1, 100])), 1, ones (2))
