...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), ...
...
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), ...
%! "alpha", 0.01, "parameter", {"k", "sigma", "param"})
...
%! proflik (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), 3)
%!error <proflik: PNUM must be a scalar number indexing a valid parameter.> ...
%! proflik (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a valid parameter.> ...
%! proflik (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (GeneralizedParetoDistribution.fit (gprnd (1, 1, 1, [1, 100]), 1), 1, ones (2))
