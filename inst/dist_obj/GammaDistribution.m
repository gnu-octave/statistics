...
classdef GammaDistribution
  ...
  methods(Access = public)
    ...
    ## @deftypefnx {GammaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {GammaDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
...
%! pdfit = GammaDistribution.fit (xdat');
