...
classdef GammaDistribution
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {GammaDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{"upper"})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {GammaDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {} plot (@var{pd})
    ## @deftypefnx {GammaDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {GammaDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {GammaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{"Display"}, @var{display})
    ## @deftypefnx {GammaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {GammaDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{"Display"}, @var{display})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {GammaDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods (Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = GammaDistribution.makeFitted (phat, pci, acov, x, censor, freq);
    endfunction
...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), ...
%! "parameter", "a", "alpha", {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), ...
%! "parameter", {"a", "b", "param"})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), ...
%! "alpha", 0.01, "parameter", {"a", "b", "param"})
...
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), ...
%! "alpha", 0.01, "parameter", "a", "NAME", "value")
...
%! proflik (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (GammaDistribution.fit (gamrnd (1, 1, [1, 100])), 1, ones (2))
