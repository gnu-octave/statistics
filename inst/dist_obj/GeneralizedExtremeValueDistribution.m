...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), ...
...
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), ...
%! "alpha", 0.01, "parameter", {"k", "sigma", "mu", "param"})
...
%! proflik (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), 4)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (GeneralizedExtremeValueDistribution.fit (gevrnd (1, 1, 1, [1, 100])), 1, ones (2))
