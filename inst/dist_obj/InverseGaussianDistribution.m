...
classdef InverseGaussianDistribution
  ...
  ##
  ## A @code{InverseGaussianDistribution} object consists of parameters, a model
  ...
  ##
  ## @item @qcode{mu} @tab Scale parameter @tab @math{mu >= 0}
  ## @item @qcode{lambda} @tab Shape parameter @tab @math{lambda > 0}
  ## @end multitable
  ##
  ## There are several ways to create a @code{InverseGaussianDistribution} object.
  ##
  ## @itemize
  ...
  ## @item Use the constructor @qcode{InverseGaussianDistribution (@var{mu}, @var{lambda})}
  ## to create a logistic distribution with specified parameter values.
  ## @item Use the static method @qcode{InverseGaussianDistribution.fit (@var{x},
  ...
  ##
  ## A @code{InverseGaussianDistribution} object contains the following properties,
  ...
  ## @end multitable
  ##
  ## A @code{InverseGaussianDistribution} object contains the following methods:
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {InverseGaussianDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {} plot (@var{pd})
    ## @deftypefnx {InverseGaussianDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {InverseGaussianDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ##
    ## For the inverse Gaussian distribution, @qcode{@var{pnum} = 1} selects the
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{y} =} random (@var{pd})
    ## @deftypefnx {InverseGaussianDistribution} {@var{y} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {InverseGaussianDistribution} {@var{y} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {InverseGaussianDistribution} {@var{y} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods (Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = InverseGaussianDistribution.makeFitted ...
...
function checkparams (mu, lambda)
  ...
  if (! (isscalar (lambda) && isnumeric (lambda) && isreal (lambda)
    ...
    error ("InverseGaussianDistribution: SIGMA must be a positive real scalar.")
  endif
endfunction
...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), "alpha")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), "alpha", 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), "alpha", 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), "alpha", [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), "alpha", "")
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), "alpha", {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), ...
...
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), ...
%! "alpha", 0.01, "parameter", {"mu", "lambda", "param"})
...
%! proflik (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), 3)
%!error <proflik: PNUM must be a scalar number indexing a valid parameter.> ...
%! proflik (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a valid parameter.> ...
%! proflik (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (InverseGaussianDistribution.fit (invgrnd (1, 1, [1, 100])), 1, ones (2))
