...
classdef InverseGaussianDistribution
  ...
  ##
  ## A @code{InverseGaussianDistribution} object consists of parameters, a
  ...
  properties(Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} lambda
    ##
    ## Shape parameter
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {InverseGaussianDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## @deftypefnx {InverseGaussianDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {InverseGaussianDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {InverseGaussianDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {InverseGaussianDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {InverseGaussianDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {InverseGaussianDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
