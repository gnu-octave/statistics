...
%!          sprintf("PDF for sample 1 with estimated μ=%0.2f and μ=%0.2f", ...
%!                  mu_lambdaA(1), mu_lambdaA(2)), ...
%!          sprintf("PDF for sample 2 with estimated μ=%0.2f and μ=%0.2f", ...
%!                  mu_lambdaB(1), mu_lambdaB(2)), ...
%!          sprintf("PDF for sample 3 with estimated μ=%0.2f and μ=%0.2f", ...
