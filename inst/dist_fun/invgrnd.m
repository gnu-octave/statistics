...
## Test results
%!assert_equal (size (invgrnd (1, 1, 1)), [1, 1])
%!assert_equal (size (invgrnd (1, 1, 2)), [2, 2])
%!assert_equal (size (invgrnd (1, 1, [2, 1])), [2, 1])
%!assert_equal (size (invgrnd (1, zeros (2, 2))), [2, 2])
%!assert_equal (size (invgrnd (1, ones (2, 1))), [2, 1])
%!assert_equal (size (invgrnd (1, ones (2, 2))), [2, 2])
%!assert_equal (size (invgrnd (ones (2, 1), 1)), [2, 1])
%!assert_equal (size (invgrnd (ones (2, 2), 1)), [2, 2])
%!assert_equal (size (invgrnd (1, 1, 3)), [3, 3])
...
%!assert_equal (class (invgrnd (1, 0)), "double")
%!assert_equal (class (invgrnd (1, single (0))), "single")
%!assert_equal (class (invgrnd (1, single ([0, 0]))), "single")
%!assert_equal (class (invgrnd (1, single (1))), "single")
%!assert_equal (class (invgrnd (1, single ([1, 1]))), "single")
%!assert_equal (class (invgrnd (single (1), 1)), "single")
%!assert_equal (class (invgrnd (single ([1, 1]), 1)), "single")
