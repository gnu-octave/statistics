...
%!assert_equal (tricdf (x, ones (1,7), 1.5 * ones (1, 7), 2 * ones (1, 7)), y, eps)
%!assert_equal (tricdf (x, 1 * ones (1, 7), 1.5, 2), y, eps)
%!assert_equal (tricdf (x, 1 * ones (1, 7), 1.5, 2, 'upper'), 1 - y, eps)
%!assert_equal (tricdf (x, 1, 1.5, 2 * ones (1, 7)), y, eps)
%!assert_equal (tricdf (x, 1, 1.5 * ones (1, 7), 2), y, eps)
%!assert_equal (tricdf (x, 1, 1.5, 2), y, eps)
%!assert_equal (tricdf (x, [1, 1, NaN, 1, 1, 1, 1], 1.5, 2), ...
%! [y(1:2), NaN, y(4:7)], eps)
%!assert_equal (tricdf (x, 1, 1.5, 2*[1, 1, NaN, 1, 1, 1, 1]), ...
%! [y(1:2), NaN, y(4:7)], eps)
%!assert_equal (tricdf (x, 1, 1.5, 2*[1, 1, NaN, 1, 1, 1, 1]), ...
%! [y(1:2), NaN, y(4:7)], eps)
%!assert_equal (tricdf ([x, NaN], 1, 1.5, 2), [y, NaN], eps)

## Test class of input preserved
%!assert_equal (tricdf (single ([x, NaN]), 1, 1.5, 2), ...
%! single ([y, NaN]), eps ('single'))
%!assert_equal (tricdf ([x, NaN], single (1), 1.5, 2), ...
%! single ([y, NaN]), eps ('single'))
%!assert_equal (tricdf ([x, NaN], 1, single (1.5), 2), ...
%! single ([y, NaN]), eps ('single'))
%!assert_equal (tricdf ([x, NaN], 1, 1.5, single (2)), ...
%! single ([y, NaN]), eps ('single'))
