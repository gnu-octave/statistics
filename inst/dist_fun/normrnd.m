...
## Test output
%!assert_equal (size (normrnd (1, 1)), [1, 1])
%!assert_equal (size (normrnd (1, ones (2, 1))), [2, 1])
%!assert_equal (size (normrnd (1, ones (2, 2))), [2, 2])
%!assert_equal (size (normrnd (ones (2, 1), 1)), [2, 1])
%!assert_equal (size (normrnd (ones (2, 2), 1)), [2, 2])
%!assert_equal (size (normrnd (1, 1, 3)), [3, 3])
%!assert_equal (size (normrnd (1, 1, [4, 1])), [4, 1])
%!assert_equal (size (normrnd (1, 1, 4, 1)), [4, 1])
%!assert_equal (size (normrnd (1, 1, 4, 1, 5)), [4, 1, 5])
%!assert_equal (size (normrnd (1, 1, 0, 1)), [0, 1])
%!assert_equal (size (normrnd (1, 1, 1, 0)), [1, 0])
...
%!assert_equal (class (normrnd (1, single (1))), "single")
%!assert_equal (class (normrnd (1, single ([1, 1]))), "single")
%!assert_equal (class (normrnd (single (1), 1)), "single")
%!assert_equal (class (normrnd (single ([1, 1]), 1)), "single")
