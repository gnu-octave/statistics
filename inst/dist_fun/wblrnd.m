...
## Test output
%!assert_equal (size (wblrnd (1, 1)), [1, 1])
%!assert_equal (size (wblrnd (1, ones (2, 1))), [2, 1])
%!assert_equal (size (wblrnd (1, ones (2, 2))), [2, 2])
%!assert_equal (size (wblrnd (ones (2, 1), 1)), [2, 1])
%!assert_equal (size (wblrnd (ones (2, 2), 1)), [2, 2])
%!assert_equal (size (wblrnd (1, 1, 3)), [3, 3])
%!assert_equal (size (wblrnd (1, 1, [4, 1])), [4, 1])
%!assert_equal (size (wblrnd (1, 1, 4, 1)), [4, 1])
%!assert_equal (size (wblrnd (1, 1, 4, 1, 5)), [4, 1, 5])
%!assert_equal (size (wblrnd (1, 1, 0, 1)), [0, 1])
%!assert_equal (size (wblrnd (1, 1, 1, 0)), [1, 0])
...
%!assert_equal (class (wblrnd (1, single (1))), "single")
%!assert_equal (class (wblrnd (1, single ([1, 1]))), "single")
%!assert_equal (class (wblrnd (single (1), 1)), "single")
%!assert_equal (class (wblrnd (single ([1, 1]), 1)), "single")
