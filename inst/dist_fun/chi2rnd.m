...
## Test output
%!assert_equal (size (chi2rnd (2)), [1, 1])
%!assert_equal (size (chi2rnd (ones (2,1))), [2, 1])
%!assert_equal (size (chi2rnd (ones (2,2))), [2, 2])
%!assert_equal (size (chi2rnd (1, 3)), [3, 3])
%!assert_equal (size (chi2rnd (1, [4, 1])), [4, 1])
%!assert_equal (size (chi2rnd (1, 4, 1)), [4, 1])
%!assert_equal (size (chi2rnd (1, 4, 1)), [4, 1])
%!assert_equal (size (chi2rnd (1, 4, 1, 5)), [4, 1, 5])
%!assert_equal (size (chi2rnd (1, 0, 1)), [0, 1])
%!assert_equal (size (chi2rnd (1, 1, 0)), [1, 0])
...
%!assert_equal (class (chi2rnd (single (2))), "single")
%!assert_equal (class (chi2rnd (single ([2 2]))), "single")
