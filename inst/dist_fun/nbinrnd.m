...
## Test output
%!assert_equal (size (nbinrnd (1, 0.5)), [1, 1])
%!assert_equal (size (nbinrnd (1, 0.5 * ones (2, 1))), [2, 1])
%!assert_equal (size (nbinrnd (1, 0.5 * ones (2, 2))), [2, 2])
%!assert_equal (size (nbinrnd (ones (2, 1), 0.5)), [2, 1])
%!assert_equal (size (nbinrnd (ones (2, 2), 0.5)), [2, 2])
%!assert_equal (size (nbinrnd (1, 0.5, 3)), [3, 3])
%!assert_equal (size (nbinrnd (1, 0.5, [4, 1])), [4, 1])
%!assert_equal (size (nbinrnd (1, 0.5, 4, 1)), [4, 1])
%!assert_equal (size (nbinrnd (1, 0.5, 4, 1, 5)), [4, 1, 5])
%!assert_equal (size (nbinrnd (1, 0.5, 0, 1)), [0, 1])
%!assert_equal (size (nbinrnd (1, 0.5, 1, 0)), [1, 0])
...
%!assert_equal (class (nbinrnd (1, single (0.5))), "single")
%!assert_equal (class (nbinrnd (1, single ([0.5, 0.5]))), "single")
%!assert_equal (class (nbinrnd (single (1), 0.5)), "single")
%!assert_equal (class (nbinrnd (single ([1, 1]), 0.5)), "single")
