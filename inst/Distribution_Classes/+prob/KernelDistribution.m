...
classdef KernelDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.KernelDistribution
  ##
  ## Kernel probability distribution object.
  ##
  ## A @code{prob.KernelDistribution} object consists of a nonparametric kernel
  ...
  properties (Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.KernelDistribution} {property} Bandwidth
    ##
  ...
  properties (GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.KernelDistribution} {property} Support
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.KernelDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.KernelDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.KernelDistribution} {property} InputData
    ##
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.KernelDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.KernelDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.KernelDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.KernelDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.KernelDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.KernelDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.KernelDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods (Static, Hidden)
    ...
    function pd = fit (x, kernel, support, width, freq)
      ...
      pd = prob.KernelDistribution (x, kernel, bw, S, freq);
    endfunction
...
%!shared pd
%! pd = prob.KernelDistribution ();
%! pd(2) = prob.KernelDistribution ();
