...
classdef HalfNormalDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.HalfNormalDistribution
  ##
  ## Half-normal probability distribution object.
  ##
  ## A @code{prob.HalfNormalDistribution} object consists of parameters, a model
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} mu
    ##
    ## Location parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} sigma
    ##
    ## Scale parameter
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.HalfNormalDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.HalfNormalDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.HalfNormalDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.HalfNormalDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.HalfNormalDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.HalfNormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.HalfNormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.HalfNormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.HalfNormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.HalfNormalDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.HalfNormalDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.HalfNormalDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.HalfNormalDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.HalfNormalDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, mu, varargin)
      ...
      pd = prob.HalfNormalDistribution.makeFitted (phat, pci, acov, x, freq);
    endfunction
...
## Test output
%!shared pd, t
%! pd = prob.HalfNormalDistribution (0, 1);
%! t = truncate (pd, 2, 4);
...
%! pdh = prob.HalfNormalDistribution.fit (x, 0);
...
## 'prob.HalfNormalDistribution' constructor
%!error <HalfNormalDistribution: MU must be a real scalar.> ...
%! prob.HalfNormalDistribution (Inf, 1)
%!error <HalfNormalDistribution: MU must be a real scalar.> ...
%! prob.HalfNormalDistribution (i, 1)
%!error <HalfNormalDistribution: MU must be a real scalar.> ...
%! prob.HalfNormalDistribution ('a', 1)
%!error <HalfNormalDistribution: MU must be a real scalar.> ...
%! prob.HalfNormalDistribution ([1, 2], 1)
%!error <HalfNormalDistribution: MU must be a real scalar.> ...
%! prob.HalfNormalDistribution (NaN, 1)
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, 0)
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, -1)
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, Inf)
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, i)
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, 'a')
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, [1, 2])
%!error <HalfNormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.HalfNormalDistribution (1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.HalfNormalDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.HalfNormalDistribution, 2, 3)

## 'paramci' method
%!shared x
%! x = hnrnd (1, 1, [1, 100]);
%!error <paramci: optional arguments must be in NAME-VALUE pairs.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'parameter', 'sigma', ...
%!          'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), ...
%!          'parameter', {'mu', 'sigma', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', 0.01, ...
%!          'parameter', {'mu', 'sigma', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', 0.01, ...
%!          'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1),'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.HalfNormalDistribution.fit (x, 1), 'alpha', 0.01, ...
%!          'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
...
%! plot (prob.HalfNormalDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.HalfNormalDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.HalfNormalDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.HalfNormalDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.HalfNormalDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.HalfNormalDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.HalfNormalDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.HalfNormalDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.HalfNormalDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.HalfNormalDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.HalfNormalDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.HalfNormalDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), {1})
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 1)
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.HalfNormalDistribution.fit (x, 1), 2, {[1 2 3 4]}, ...
%!          'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.HalfNormalDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.HalfNormalDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.HalfNormalDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.HalfNormalDistribution (1, 1);
%! pd(2) = prob.HalfNormalDistribution (1, 3);
