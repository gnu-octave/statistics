...
classdef LogisticDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.LogisticDistribution
  ##
  ## Logistic probability distribution object.
  ##
  ## A @code{prob.LogisticDistribution} object consists of parameters, a model
  ...
  ## @var{sigma}.
  ##
  ## There are several ways to create a @code{prob.LogisticDistribution}
  ## object.
  ##
  ## @itemize
  ...
  ## @item Use the constructor @qcode{prob.LogisticDistribution (@var{mu},
  ## @var{sigma})} to create a logistic distribution with fixed parameter values
  ## @var{mu} and @var{sigma}.
  ## @item Use the static method @qcode{prob.LogisticDistribution.fit (@var{x},
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} mu
    ##
    ## Location parameter
    ##
    ## A scalar value characterizing the location of the
    ## logistic distribution. You can access the @qcode{mu}
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} sigma
    ##
    ## Scale parameter
    ##
    ## A positive scalar value characterizing the scale of the
    ## logistic distribution. You can access the @qcode{sigma}
    ## property using dot name assignment.
    ##
    ## @end deftp
    sigma
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LogisticDistribution} {property} InputData
    ##
  ...
  methods(Hidden)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{pd} =} LogisticDistribution (@var{mu}, @var{sigma})
    ## @deftypefnx {prob.LogisticDistribution} {@var{pd} =} LogisticDistribution ()
    ##
    ## Create a @code{prob.LogisticDistribution} object.
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.LogisticDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.LogisticDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.LogisticDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.LogisticDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.LogisticDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.LogisticDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.LogisticDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.LogisticDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.LogisticDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.LogisticDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.LogisticDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.LogisticDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LogisticDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.LogisticDistribution.makeFitted ...
...
## Test output
%!shared pd, t
%! pd = prob.LogisticDistribution (0, 1);
%! t = truncate (pd, 2, 4);
...
## 'prob.LogisticDistribution' constructor
%!error <LogisticDistribution: MU must be a finite real scalar.> ...
%! prob.LogisticDistribution (Inf, 1)
%!error <LogisticDistribution: MU must be a finite real scalar.> ...
%! prob.LogisticDistribution (i, 1)
%!error <LogisticDistribution: MU must be a finite real scalar.> ...
%! prob.LogisticDistribution ('a', 1)
%!error <LogisticDistribution: MU must be a finite real scalar.> ...
%! prob.LogisticDistribution ([1, 2], 1)
%!error <LogisticDistribution: MU must be a finite real scalar.> ...
%! prob.LogisticDistribution (NaN, 1)
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, 0)
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, -1)
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, Inf)
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, i)
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, 'a')
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, [1, 2])
%!error <LogisticDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LogisticDistribution (1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.LogisticDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.LogisticDistribution, 2, 3)

## 'paramci' method
%!shared x
%! x = logirnd (1, 1, [1, 100]);
%!error <paramci: optional arguments must be in NAME-VALUE pairs.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'parameter', 'mu', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'parameter', {'mu', 'sigma', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'mu', 'sigma', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', 0.01, 'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', 0.01, 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.LogisticDistribution.fit (x), 'alpha', 0.01, 'parameter', 'mu', ...
%!          'NAME', 'value')

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.LogisticDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.LogisticDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.LogisticDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.LogisticDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.LogisticDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.LogisticDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.LogisticDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.LogisticDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.LogisticDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.LogisticDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.LogisticDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.LogisticDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.LogisticDistribution.fit (x), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.LogisticDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.LogisticDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.LogisticDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.LogisticDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.LogisticDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.LogisticDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.LogisticDistribution (1, 1);
%! pd(2) = prob.LogisticDistribution (1, 3);
