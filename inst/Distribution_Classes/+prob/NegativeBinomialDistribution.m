...
classdef NegativeBinomialDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.NegativeBinomialDistribution
  ##
  ## Negative binomial probability distribution object.
  ##
  ## A @code{prob.NegativeBinomialDistribution} object consists of parameters, a
  ...
  ## @var{R} and the probability of success @var{P}.
  ##
  ## There are several ways to create a @code{prob.NegativeBinomialDistribution}
  ## object.
  ##
  ## @itemize
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} R
    ##
    ## Number of successes
    ##
    ## A scalar value characterizing the number of successes in the
    ## negative binomial distribution.  You can access the @qcode{R}
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} P
    ##
    ## Probability of success
    ##
    ## A scalar value characterizing the probability of success in the
    ## negative binomial distribution.  You can access the @qcode{P}
    ## property using dot name assignment.
    ##
    ## @end deftp
    P
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NegativeBinomialDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.NegativeBinomialDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## distribution object @var{pd}.
    ##
    ## When called with a single size argument, @code{nbindrnd} returns a square
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NegativeBinomialDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.NegativeBinomialDistribution.makeFitted (phat, pci, acov, x, freq);
    endfunction
...
## Test output
%!shared pd, t, t_inf
%! pd = prob.NegativeBinomialDistribution (5, 0.5);
%! t = truncate (pd, 2, 4);
...
## 'prob.NegativeBinomialDistribution' constructor
%!error <NegativeBinomialDistribution: R must be a positive scalar.> ...
%! prob.NegativeBinomialDistribution (Inf, 1)
%!error <NegativeBinomialDistribution: R must be a positive scalar.> ...
%! prob.NegativeBinomialDistribution (i, 1)
%!error <NegativeBinomialDistribution: R must be a positive scalar.> ...
%! prob.NegativeBinomialDistribution ('a', 1)
%!error <NegativeBinomialDistribution: R must be a positive scalar.> ...
%! prob.NegativeBinomialDistribution ([1, 2], 1)
%!error <NegativeBinomialDistribution: R must be a positive scalar.> ...
%! prob.NegativeBinomialDistribution (NaN, 1)
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, 0)
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, -1)
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, Inf)
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, i)
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, 'a')
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, [1, 2])
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, NaN)
%!error <NegativeBinomialDistribution: P must be a real scalar bounded in the range> ...
%! prob.NegativeBinomialDistribution (1, 1.2)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.NegativeBinomialDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.NegativeBinomialDistribution, 2, 3)

## 'paramci' method
%!shared x
%! x = nbinrnd (1, 0.5, [1, 100]);
%!error <paramci: optional arguments must be in NAME-VALUE pairs.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'parameter', 'R', ...
%!          'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), ...
%!          'parameter', {'R', 'P', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'R', 'P', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.NegativeBinomialDistribution.fit (x), 'alpha', 0.01, ...
%!          'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
...
%! plot (prob.NegativeBinomialDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.NegativeBinomialDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.NegativeBinomialDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.NegativeBinomialDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.NegativeBinomialDistribution.fit (x), 1, {[1 2 3]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.NegativeBinomialDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.NegativeBinomialDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.NegativeBinomialDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.NegativeBinomialDistribution (1, 0.5);
%! pd(2) = prob.NegativeBinomialDistribution (1, 0.6);
