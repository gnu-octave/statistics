...
classdef BirnbaumSaundersDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.BirnbaumSaundersDistribution
  ##
  ## Birnbaum-Saunders probability distribution object.
  ##
  ## A @code{prob.BirnbaumSaundersDistribution} object consists of parameters, a
  ...
  ## @var{gamma}.
  ##
  ## There are several ways to create a @code{prob.BirnbaumSaundersDistribution}
  ## object.
  ##
  ## @itemize
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} beta
    ##
    ## Scale parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} gamma
    ##
    ## Shape parameter
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.BirnbaumSaundersDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.BirnbaumSaundersDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.BirnbaumSaundersDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.BirnbaumSaundersDistribution.makeFitted ...
...
## Test output
%!shared pd, t
%! pd = prob.BirnbaumSaundersDistribution;
%! t = truncate (pd, 2, 4);
...
## 'prob.BirnbaumSaundersDistribution' constructor
%!error <BirnbaumSaundersDistribution: BETA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (0, 1)
%!error <BirnbaumSaundersDistribution: BETA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (Inf, 1)
%!error <BirnbaumSaundersDistribution: BETA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (i, 1)
%!error <BirnbaumSaundersDistribution: BETA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution ('beta', 1)
%!error <BirnbaumSaundersDistribution: BETA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution ([1, 2], 1)
%!error <BirnbaumSaundersDistribution: BETA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (NaN, 1)
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, 0)
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, -1)
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, Inf)
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, i)
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, 'beta')
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, [1, 2])
%!error <BirnbaumSaundersDistribution: GAMMA must be a positive real scalar.> ...
%! prob.BirnbaumSaundersDistribution (1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.BirnbaumSaundersDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.BirnbaumSaundersDistribution, 2, 3)
...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'parameter', ...
%!          'beta', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), ...
%!          'parameter', {'beta', 'gamma', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'beta', 'gamma', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.BirnbaumSaundersDistribution.fit (x), 'alpha', 0.01, ...
%!          'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
...
%! plot (prob.BirnbaumSaundersDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.BirnbaumSaundersDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.BirnbaumSaundersDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.BirnbaumSaundersDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.BirnbaumSaundersDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.BirnbaumSaundersDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.BirnbaumSaundersDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.BirnbaumSaundersDistribution (1, 1);
%! pd(2) = prob.BirnbaumSaundersDistribution (1, 3);
