...
classdef PiecewiseLinearDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.PiecewiseLinearDistribution
  ##
  ...
  ##
  ## There are several ways to create a @code{prob.PiecewiseLinearDistribution}
  ## object.
  ##
  ## @itemize
  ## @item Create a distribution with specified parameter values using the
  ## @code{makedist} function.
  ## @item Use the constructor @qcode{prob.PiecewiseLinearDistribution (@var{x},
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} x
    ##
    ## Vector of x values
    ##
    ...
    x
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} Fx
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} NumParameters
    ##
    ...
    NumParameters = 2;
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ParameterNames = {'x', 'Fx'};
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public , SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} ParameterValues
    ##
    ...
    ParameterValues
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    Truncation
    ## -*- texinfo -*-
    ## @deftp {prob.PiecewiseLinearDistribution} {property} IsTruncated
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.PiecewiseLinearDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.PiecewiseLinearDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.PiecewiseLinearDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.PiecewiseLinearDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.PiecewiseLinearDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.PiecewiseLinearDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.PiecewiseLinearDistribution} {@var{v} =} var (@var{pd})
    ##
...
%! f = f(1:5:end);
%! x = x(1:5:end);
%! pd = prob.PiecewiseLinearDistribution (x, f);
...
%!error <PiecewiseLinearDistribution: X must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([0, i], [0, 1])
%!error <PiecewiseLinearDistribution: X must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([0, Inf], [0, 1])
%!error <PiecewiseLinearDistribution: X must be a real vector.> ...
%! prob.PiecewiseLinearDistribution (['a', 'c'], [0, 1])
%!error <PiecewiseLinearDistribution: X must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([NaN, 1], [0, 1])
%!error <PiecewiseLinearDistribution: Fx must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([0, 1], [0, i])
%!error <PiecewiseLinearDistribution: Fx must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([0, 1], [0, Inf])
%!error <PiecewiseLinearDistribution: Fx must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([0, 1], ['a', 'c'])
%!error <PiecewiseLinearDistribution: Fx must be a real vector.> ...
%! prob.PiecewiseLinearDistribution ([0, 1], [NaN, 1])
%!error <PiecewiseLinearDistribution: X and FX must be vectors of equal size.> ...
%! prob.PiecewiseLinearDistribution ([0, 1], [0, 0.5, 1])
%!error <PiecewiseLinearDistribution: X and FX must be at least two-elements long.> ...
%! prob.PiecewiseLinearDistribution ([0], [1])
%!error <PiecewiseLinearDistribution: FX must be bounded in the range> ...
%! prob.PiecewiseLinearDistribution ([0, 0.5, 1], [0, 1, 1.5])

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.PiecewiseLinearDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.PiecewiseLinearDistribution, 2, 3)

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.PiecewiseLinearDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.PiecewiseLinearDistribution, 'invalidNAME', 'pdf')
%!error <plot: 'probability' PlotType is not supported for 'Piecewise Linear'.> ...
%! plot (prob.PiecewiseLinearDistribution, 'PlotType', 'probability')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.PiecewiseLinearDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.PiecewiseLinearDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.PiecewiseLinearDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.PiecewiseLinearDistribution ();
%! pd(2) = prob.PiecewiseLinearDistribution ();
