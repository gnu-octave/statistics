...
classdef NakagamiDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.NakagamiDistribution
  ##
  ## Nakagami probability distribution object.
  ##
  ## A @code{prob.NakagamiDistribution} object consists of parameters, a model
  ...
  ## @var{omega}.
  ##
  ## There are several ways to create a @code{prob.NakagamiDistribution} object.
  ##
  ## @itemize
  ...
  ## @item Use the constructor @qcode{prob.NakagamiDistribution (@var{mu},
  ## @var{omega})} to create a Nakagami distribution with fixed parameter
  ## values @var{mu} and @var{omega}.
  ## @item Use the static method @qcode{prob.NakagamiDistribution.fit (@var{x},
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} mu
    ##
    ## Shape parameter
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} omega
    ##
    ## Spread parameter
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public , SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.NakagamiDistribution} {property} InputData
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.NakagamiDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.NakagamiDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.NakagamiDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.NakagamiDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.NakagamiDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.NakagamiDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.NakagamiDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.NakagamiDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.NakagamiDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.NakagamiDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.NakagamiDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.NakagamiDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.NakagamiDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.NakagamiDistribution.makeFitted (phat, pci, acov, x, censor, freq);
    endfunction
...
## Test output
%!shared pd, t
%! pd = prob.NakagamiDistribution;
%! t = truncate (pd, 2, 4);
%!assert_equal (cdf (pd, [0:5]), [0, 0.6321, 0.9817, 0.9999, 1, 1], 1e-4);
%!assert_equal (cdf (t, [0:5]), [0, 0, 0, 0.9933, 1, 1], 1e-4);
%!assert_equal (cdf (pd, [1.5, 2, 3, 4]), [0.8946, 0.9817, 0.9999, 1], 1e-4);
%!assert_equal (cdf (t, [1.5, 2, 3, 4]), [0, 0, 0.9933, 1], 1e-4);
%!assert_equal (icdf (pd, [0:0.2:1]), [0, 0.4724, 0.7147, 0.9572, 1.2686, Inf], 1e-4);
%!assert_equal (icdf (t, [0:0.2:1]), [2, 2.0550, 2.1239, 2.2173, 2.3684, 4], 1e-4);
%!assert_equal (icdf (pd, [-1, 0.4:0.2:1, NaN]), [NaN, 0.7147, 0.9572, 1.2686, Inf, NaN], 1e-4);
%!assert_equal (icdf (t, [-1, 0.4:0.2:1, NaN]), [NaN, 2.1239, 2.2173, 2.3684, 4, NaN], 1e-4);
%!assert_equal (iqr (pd), 0.6411, 1e-4);
%!assert_equal (iqr (t), 0.2502, 1e-4);
%!assert_equal (mean (pd), 0.8862, 1e-4);
%!assert_equal (mean (t), 2.2263, 1e-4);
%!assert_equal (median (pd), 0.8326, 1e-4);
%!assert_equal (median (t), 2.1664, 1e-4);
%!assert_equal (pdf (pd, [0:5]), [0, 0.7358, 0.0733, 0.0007, 0, 0], 1e-4);
%!assert_equal (pdf (t, [0:5]), [0, 0, 4, 0.0404, 0, 0], 1e-4);
%!assert_equal (pdf (pd, [-1, 1:4, NaN]), [0, 0.7358, 0.0733, 0.0007, 0, NaN], 1e-4);
%!assert_equal (pdf (t, [-1, 1:4, NaN]), [0, 0, 4, 0.0404, 0, NaN], 1e-4);
...
%!assert_equal (std (pd), 0.4633, 1e-4);
%!assert_equal (std (t), 0.2083, 1e-4);
%!assert_equal (var (pd), 0.2146, 1e-4);
%!assert_equal (var (t), 0.0434, 1e-4);
...
## 'prob.NakagamiDistribution' constructor
%!error <NakagamiDistribution: MU must be a real scalar of at least 0.5.> ...
%! prob.NakagamiDistribution (Inf, 1)
%!error <NakagamiDistribution: MU must be a real scalar of at least 0.5.> ...
%! prob.NakagamiDistribution (i, 1)
%!error <NakagamiDistribution: MU must be a real scalar of at least 0.5.> ...
%! prob.NakagamiDistribution ('a', 1)
%!error <NakagamiDistribution: MU must be a real scalar of at least 0.5.> ...
%! prob.NakagamiDistribution ([1, 2], 1)
%!error <NakagamiDistribution: MU must be a real scalar of at least 0.5.> ...
%! prob.NakagamiDistribution (NaN, 1)
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, 0)
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, -1)
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, Inf)
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, i)
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, 'a')
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, [1, 2])
%!error <NakagamiDistribution: OMEGA must be a positive real scalar.> ...
%! prob.NakagamiDistribution (1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.NakagamiDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.NakagamiDistribution, 2, 3)

## 'paramci' method
%!shared x
%! x = nakarnd (1, 0.5, [1, 100]);
%!error <paramci: optional arguments must be in NAME-VALUE pairs.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'parameter', 'mu', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'parameter', {'mu', 'omega', 'param'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'mu', 'omega', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', 0.01, 'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', 0.01, 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.NakagamiDistribution.fit (x), 'alpha', 0.01, 'parameter', 'mu', ...
%!          'NAME', 'value')

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.NakagamiDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.NakagamiDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.NakagamiDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.NakagamiDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.NakagamiDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.NakagamiDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.NakagamiDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.NakagamiDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.NakagamiDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.NakagamiDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.NakagamiDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.NakagamiDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.NakagamiDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.NakagamiDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.NakagamiDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.NakagamiDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.NakagamiDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.NakagamiDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.NakagamiDistribution (1, 0.5);
%! pd(2) = prob.NakagamiDistribution (1, 0.6);
