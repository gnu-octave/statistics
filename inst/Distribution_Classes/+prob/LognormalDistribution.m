...
classdef LognormalDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.LognormalDistribution
  ##
  ## Lognormal probability distribution object.
  ##
  ## A @code{prob.LognormalDistribution} object consists of parameters, a model
  ...
  ## @item Use the constructor @qcode{prob.LognormalDistribution (@var{mu},
  ## @var{sigma})} to create a lognormal distribution with fixed parameter
  ## values @var{mu} and @var{sigma}.
  ## @item Use the static method @qcode{prob.LognormalDistribution.fit (@var{x},
  ## @var{censor}, @var{freq}, @var{options})} to fit a distribution to the
  ## data in @var{x} using the same input arguments as the @code{lognfit}
  ## function.
  ## @end itemize
  ##
  ...
  properties(Dependent = true)
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} sigma
    ##
    ...
    ## @qcode{sigma} property using dot name assignment.
    ##
    ## @end deftp
    sigma
  endproperties
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public, SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} IsTruncated
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} ParameterCovariance
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} ParameterIsFixed
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.LognormalDistribution} {property} InputData
    ##
  ...
  methods(Hidden)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{pd} =} LognormalDistribution (@var{mu}, @var{sigma})
    ## @deftypefnx {prob.LognormalDistribution} {@var{pd} =} LognormalDistribution ()
    ##
    ## Create a @code{prob.LognormalDistribution} object.
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.LognormalDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{x} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{nlogL} =} negloglik (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{ci} =} paramci (@var{pd})
    ## @deftypefnx {prob.LognormalDistribution} {@var{ci} =} paramci (@var{pd}, @var{Name}, @var{Value})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.LognormalDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.LognormalDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum})
    ## @deftypefnx {prob.LognormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.LognormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam})
    ## @deftypefnx {prob.LognormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd}, @var{pnum}, @var{setparam}, @qcode{'Display'}, @var{display})
    ## @deftypefnx {prob.LognormalDistribution} {[@var{nlogL}, @var{param}] =} proflik (@var{pd})
    ## @deftypefnx {prob.LognormalDistribution} {[@var{nlogL}, @var{param}, @var{other}] =} proflik (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{r} =} random (@var{pd})
    ## @deftypefnx {prob.LognormalDistribution} {@var{r} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.LognormalDistribution} {@var{r} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.LognormalDistribution} {@var{r} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.LognormalDistribution} {@var{v} =} var (@var{pd})
    ##
  ...
  methods(Static, Hidden)
    ...
    function pd = fit (x, varargin)
      ...
      pd = prob.LognormalDistribution.makeFitted ...
...
## 'prob.LognormalDistribution' constructor
%!error <LognormalDistribution: MU must be a real scalar.> ...
%! prob.LognormalDistribution (Inf, 1)
%!error <LognormalDistribution: MU must be a real scalar.> ...
%! prob.LognormalDistribution (i, 1)
%!error <LognormalDistribution: MU must be a real scalar.> ...
%! prob.LognormalDistribution ('a', 1)
%!error <LognormalDistribution: MU must be a real scalar.> ...
%! prob.LognormalDistribution ([1, 2], 1)
%!error <LognormalDistribution: MU must be a real scalar.> ...
%! prob.LognormalDistribution (NaN, 1)
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, 0)
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, -1)
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, Inf)
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, i)
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, 'a')
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, [1, 2])
%!error <LognormalDistribution: SIGMA must be a positive real scalar.> ...
%! prob.LognormalDistribution (1, NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.LognormalDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.LognormalDistribution, 2, 3)
...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', 0)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', 1)
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', [0.5 2])
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', '')
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', {0.05})
%!error <paramci: invalid VALUE for 'Alpha' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'parameter', 'mu', 'alpha', {0.05})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'parameter', {'mu', 'sigma', 'parm'})
%!error <paramci: invalid VALUE size for 'Parameter' argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', 0.01, ...
%!          'parameter', {'mu', 'sigma', 'param'})
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'parameter', 'param')
%!error <paramci: unknown distribution parameter.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', 0.01, 'parameter', 'param')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', 0.01, 'NAME', 'value')
%!error <paramci: invalid NAME for optional argument.> ...
%! paramci (prob.LognormalDistribution.fit (x), 'alpha', 0.01, 'parameter', 'mu', ...
%!          'NAME', 'value')

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.LognormalDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.LognormalDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.LognormalDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.LognormalDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.LognormalDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.LognormalDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.LognormalDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.LognormalDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.LognormalDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.LognormalDistribution, 'invalidNAME', 'pdf')
%!error <plot: no fitted DATA to plot a probability plot.> ...
%! plot (prob.LognormalDistribution, 'PlotType', 'probability')

## 'proflik' method
%!error <proflik: no fitted data available.> ...
%! proflik (prob.LognormalDistribution, 2)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.LognormalDistribution.fit (x), 3)
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.LognormalDistribution.fit (x), [1, 2])
%!error <proflik: PNUM must be a scalar number indexing a non-fixed parameter.> ...
%! proflik (prob.LognormalDistribution.fit (x), {1})
%!error <proflik: SETPARAM must be a numeric vector.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, ones (2))
%!error <proflik: missing VALUE for 'Display' argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'Display')
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'Display', 1)
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'Display', {1})
%!error <proflik: invalid VALUE type for 'Display' argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'Display', {'on'})
%!error <proflik: invalid VALUE size for 'Display' argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'Display', ['on'; 'on'])
%!error <proflik: invalid VALUE for 'Display' argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'Display', 'onnn')
%!error <proflik: invalid NAME for optional arguments.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, 'NAME', 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, {'NAME'}, 'on')
%!error <proflik: invalid optional argument.> ...
%! proflik (prob.LognormalDistribution.fit (x), 1, {[1 2 3 4]}, 'Display', 'on')

## 'truncate' method
%!error <truncate: missing input argument.> ...
%! truncate (prob.LognormalDistribution)
%!error <truncate: missing input argument.> ...
%! truncate (prob.LognormalDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.LognormalDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.LognormalDistribution (1, 1);
%! pd(2) = prob.LognormalDistribution (1, 3);
