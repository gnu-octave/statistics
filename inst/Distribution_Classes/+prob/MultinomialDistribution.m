...
classdef MultinomialDistribution < prob.ProbabilityDistribution
  ## -*- texinfo -*-
  ## @deftp {statistics} prob.MultinomialDistribution
  ##
  ...
  ## @qcode{prob.MultinomialDistribution
  ## (@var{Probabilities})}
  ...
  properties(Dependent = true)
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} Probabilities
    ##
  ...
  properties(GetAccess = public, Constant = true)
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} DistributionName
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} NumParameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} ParameterNames
    ##
    ## Names of parameters
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} ParameterDescription
    ##
  ...
  properties(GetAccess = public , SetAccess = protected)
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} ParameterValues
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} Truncation
    ##
    ## Truncation interval
    ##
    ...
    ## -*- texinfo -*-
    ## @deftp {prob.MultinomialDistribution} {property} IsTruncated
    ##
  ...
  methods(Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{p} =} cdf (@var{pd}, @var{x})
    ## @deftypefnx {prob.MultinomialDistribution} {@var{p} =} cdf (@var{pd}, @var{x}, @qcode{'upper'})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{p} =} icdf (@var{pd}, @var{p})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{r} =} iqr (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{m} =} mean (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{m} =} median (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{y} =} pdf (@var{pd}, @var{x})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {} plot (@var{pd})
    ## @deftypefnx {prob.MultinomialDistribution} {} plot (@var{pd}, @var{Name}, @var{Value})
    ## @deftypefnx {prob.MultinomialDistribution} {@var{h} =} plot (@dots{})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{y} =} random (@var{pd})
    ## @deftypefnx {prob.MultinomialDistribution} {@var{y} =} random (@var{pd}, @var{rows})
    ## @deftypefnx {prob.MultinomialDistribution} {@var{y} =} random (@var{pd}, @var{rows}, @var{cols}, @dots{})
    ## @deftypefnx {prob.MultinomialDistribution} {@var{y} =} random (@var{pd}, [@var{sz}])
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{s} =} std (@var{pd})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{t} =} truncate (@var{pd}, @var{lower}, @var{upper})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {prob.MultinomialDistribution} {@var{v} =} var (@var{pd})
    ##
...
## Test output
%!shared pd, t
%! pd = prob.MultinomialDistribution ([0.1, 0.2, 0.3, 0.2, 0.1, 0.1]);
%! t = truncate (pd, 2, 4);
...
## 'prob.MultinomialDistribution' constructor
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution (0)
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution (-1)
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution (Inf)
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution (i)
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution ('a')
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution ([1, 2])
%!error <MultinomialDistribution: PROBABILITIES must be a vector of positive real scalars that sum up to 1.> ...
%! prob.MultinomialDistribution (NaN)

## 'cdf' method
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.MultinomialDistribution, 2, 'uper')
%!error <cdf: invalid argument for upper tail.> ...
%! cdf (prob.MultinomialDistribution, 2, 3)
%!error <cdf: X must be real.> ...
%! cdf (prob.MultinomialDistribution, i)

## 'plot' method
%!error <plot: optional arguments must be in NAME-VALUE pairs.> ...
%! plot (prob.MultinomialDistribution, 'Parent')
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.MultinomialDistribution, 'PlotType', 12)
%!error <plot: invalid VALUE size for 'Parameter' argument.> ...
%! plot (prob.MultinomialDistribution, 'PlotType', {'pdf', 'cdf'})
%!error <plot: invalid VALUE for 'PlotType' argument.> ...
%! plot (prob.MultinomialDistribution, 'PlotType', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.MultinomialDistribution, 'Discrete', 'pdfcdf')
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.MultinomialDistribution, 'Discrete', [1, 0])
%!error <plot: invalid VALUE for 'Discrete' argument.> ...
%! plot (prob.MultinomialDistribution, 'Discrete', {true})
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.MultinomialDistribution, 'Parent', 12)
%!error <plot: invalid VALUE for 'Parent' argument.> ...
%! plot (prob.MultinomialDistribution, 'Parent', 'hax')
%!error <plot: invalid NAME for optional argument.> ...
%! plot (prob.MultinomialDistribution, 'invalidNAME', 'pdf')
%!error <plot: 'probability' PlotType is not supported for 'Multinomial'.> ...
%! plot (prob.MultinomialDistribution, 'PlotType', 'probability')

## 'truncate' method
%!error <truncate: is_nan input argument.> ...
%! truncate (prob.MultinomialDistribution)
%!error <truncate: is_nan input argument.> ...
%! truncate (prob.MultinomialDistribution, 2)
%!error <truncate: invalid lower upper limits.> ...
%! truncate (prob.MultinomialDistribution, 4, 2)

## Catch errors when using array of probability objects with available methods
%!shared pd
%! pd = prob.MultinomialDistribution ([0.1, 0.2, 0.3, 0.4]);
%! pd(2) = prob.MultinomialDistribution ([0.1, 0.2, 0.3, 0.4]);
