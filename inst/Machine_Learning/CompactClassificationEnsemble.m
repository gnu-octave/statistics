...
classdef CompactClassificationEnsemble < PredictiveModel
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {CompactClassificationEnsemble} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationEnsemble} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
