...
classdef CompactClassificationSVM < PredictiveModel
  ## -*- texinfo -*-
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {CompactClassificationSVM} {@var{L} =} loss (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationSVM} {@var{L} =} loss (@var{obj}, @var{Tbl})
    ...
    ## @deftypefnx {CompactClassificationSVM} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationSVM} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
...
%!test
%! load fisheriris
%! Mdl = compact (fitcsvm (meas, strcmp (species, 'setosa')));
