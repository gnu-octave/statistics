...
classdef ClassificationECOC < PredictiveModel
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {ClassificationECOC} {@var{m} =} margin (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationECOC} {@var{m} =} margin (@var{obj}, @var{Tbl})
    ##
    ...
    ## @deftypefnx {ClassificationECOC} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationECOC} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
