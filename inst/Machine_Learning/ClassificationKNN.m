...
classdef ClassificationKNN < PredictiveModel
  ## -*- texinfo -*-
  ## @deftp {statistics} ClassificationKNN
  ##
  ## K-nearest neighbors classification
  ##
  ## The @code{ClassificationKNN} class implements a K-nearest neighbor
  ## classifier object, which can predict responses for new data using the
  ## @code{predict} method.  The implemented algorithm allows you choose a range
  ...
  methods (Access = public)
    ...
    ##
    ## @item @qcode{'BreakTies'} @tab A character vector specifying the
    ...
    ## the tied groups.
    ##
    ## @item @qcode{'NumNeighbors'} @tab A positive integer value that
    ...
    ## it is 1.
    ##
    ## @item @qcode{'Distance'} @tab Any valid distance metric supported by
    ## the @code{pdist2} function.  Note that the allowable distance metrics
    ## depend on the selected nearest neighbor search method.
    ##
    ## @item @qcode{'DistanceWeight'} @tab Either a distance weighting
    ...
    ##
    ## @item @qcode{'Cov'} @tab A square matrix with the same number of
    ...
    ## @qcode{'mahalanobis'}.
    ##
    ## @item @qcode{'Exponent'} @tab A positive scalar (usually an integer)
    ...
    ## it is 2.
    ##
    ## @item @qcode{'Scale'} @tab A nonnegative numeric vector specifying
    ...
    ##
    ## @item @qcode{'NSMethod'} @tab A character vector specifying the
    ...
    ## search method.
    ##
    ## @item @qcode{'BucketSize'} @tab A positive integer value specifying
    ...
    ## @deftypefnx {ClassificationKNN} {@var{m} =} margin (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationKNN} {@var{m} =} margin (@var{obj}, @var{Tbl})
    ##
...
%! rand ("state", 1); randn ("state", 1); Mc = fitcknn (Xch, Ych);
%! rand ("state", 1); randn ("state", 1); Ms = fitcknn (Xch, Ycell);
...
%! rand ("state", 1); randn ("state", 1); Md = fitcknn (Xmiss, Ych);
%! rand ("state", 1); randn ("state", 1); Ms = fitcknn (Xmiss, Ycell);
