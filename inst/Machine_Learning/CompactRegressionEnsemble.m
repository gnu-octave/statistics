...
classdef CompactRegressionEnsemble < PredictiveModel
  ...
  methods (Access = public)
    ...
    function yfit = predict (this, X, varargin)
      ...
      X = tableColumns (this, 'CompactRegressionEnsemble.predict', X);
  ...
  methods (Access = private)
    ...
    function o = ensembleArgs (this, X, args, allowed, caller)
      ...
      ## whole ensemble, uniform weights and the mse loss.
...
%!error<CompactRegressionEnsemble.predict: invalid optional paired argument.> ...
...
%!error <CompactRegressionEnsemble.loss: 'Weights' must be a real vector of class single or double.> ...
%! loss (compact (fitrensemble ([1, 2; 3, 4; 5, 6; 7, 8], (1:4)', ...
%!       'NumLearningCycles', 3)), ...
%!       [1, 2; 3, 4; 5, 6; 7, 8], (1:4)', 'Weights', int8 ([1; 1; 1; 1]))
