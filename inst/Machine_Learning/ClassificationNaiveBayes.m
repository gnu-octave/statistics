...
classdef ClassificationNaiveBayes < PredictiveModel
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {ClassificationNaiveBayes} {@var{m} =} margin (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationNaiveBayes} {@var{m} =} margin (@var{obj}, @var{Tbl})
    ##
    ...
    ## @deftypefnx {ClassificationNaiveBayes} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationNaiveBayes} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
    ...
    ## @deftypefnx {ClassificationNaiveBayes} {@var{l} =} loss (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationNaiveBayes} {@var{l} =} loss (@var{obj}, @var{Tbl})
