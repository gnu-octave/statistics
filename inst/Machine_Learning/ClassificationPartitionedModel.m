      ...
      switch (this.CrossValidatedModel)
        ...
        case 'KNN'
          ...
          KNNparams = {'PredictorNames', 'ResponseName', 'ClassNames', ...
                       ...
                       'NSMethod', 'BucketSize', 'CacheSize', ...
                       'NumNeighbors', 'Exponent', ...
...
%!test
%! load fisheriris
%! Mdl = crossval (fitcknn (meas, species), 'KFold', 3);
