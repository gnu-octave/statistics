...
classdef CompactRegressionNeuralNetwork < PredictiveModel
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {CompactRegressionNeuralNetwork} {@var{L} =} loss (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactRegressionNeuralNetwork} {@var{L} =} loss (@var{obj}, @var{Tbl})
