...
classdef ClassificationKernel < PredictiveModel
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {ClassificationKernel} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationKernel} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
    ...
    ## @deftypefnx {ClassificationKernel} {@var{l} =} loss (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationKernel} {@var{l} =} loss (@var{obj}, @var{Tbl})
...
%!               sort ({'BoxConstraint'; 'ClassNames'; 'Prior'; 'Cost'; ...
%!                      'ScoreTransform'; 'PredictorNames'; ...
%!                      'CategoricalPredictors'; 'ResponseName'; ...
%!                      'ExpandedPredictorNames'; 'NumExpansionDimensions'; ...
%!                      'FittedLoss'; 'Lambda'; 'ModelParameters'; ...
%!                      'Regularization'; 'KernelScale'; 'Learner'; 'Mu'; ...
%!                      'Sigma'}));
...
%!test
%! load fisheriris
%! Mdl = fitckernel (meas, strcmp (species, 'setosa'));
