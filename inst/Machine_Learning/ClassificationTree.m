...
classdef ClassificationTree < PredictiveModel
  ## -*- texinfo -*-
...
%!error<ClassificationTree.edge: optional arguments must be given in Name-Value pairs.> ...
%! edge (ClassificationTree (ones (4, 2), [1; 1; 2; 2]), ones (4, 2), ...
%!       [1; 1; 2; 2], 'Weights')
%!error<ClassificationTree.edge: invalid optional paired argument.> ...
%! edge (ClassificationTree (ones (4, 2), [1; 1; 2; 2]), ones (4, 2), ...
%!       [1; 1; 2; 2], 'Bogus', 1)
%!error<ClassificationTree.loss: too few input arguments.>
