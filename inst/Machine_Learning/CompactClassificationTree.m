...
classdef CompactClassificationTree < PredictiveModel
  ## -*- texinfo -*-
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {CompactClassificationTree} {@var{m} =} margin (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationTree} {@var{m} =} margin (@var{obj}, @var{Tbl})
    ##
