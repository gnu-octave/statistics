...
classdef ClassificationDiscriminant < PredictiveModel
  ## -*- texinfo -*-
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {ClassificationDiscriminant} {@var{m} =} margin (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationDiscriminant} {@var{m} =} margin (@var{obj}, @var{Tbl})
    ##
    ...
    ## @deftypefnx {ClassificationDiscriminant} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {ClassificationDiscriminant} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
...
%! rand ("state", 1); randn ("state", 1); Mc = fitcdiscr (Xch, Ych);
%! rand ("state", 1); randn ("state", 1); Ms = fitcdiscr (Xch, Ycell);
...
%! rand ("state", 1); randn ("state", 1); Md = fitcdiscr (Xmiss, Ych);
%! rand ("state", 1); randn ("state", 1); Ms = fitcdiscr (Xmiss, Ycell);
...
%! load fisheriris
%! rand ("state", 1); randn ("state", 1);
%! Mf = fitcdiscr (meas, char (species), ...
