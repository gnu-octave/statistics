...
classdef CompactClassificationDiscriminant < PredictiveModel
  ## -*- texinfo -*-
  ...
  methods (Hidden)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {CompactClassificationDiscriminant} {@var{obj} =} CompactClassificationDiscriminant (@var{Mdl})
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{obj} =} CompactClassificationDiscriminant ()
    ##
    ## Create a @code{CompactClassificationDiscriminant} object.
    ##
    ## @var{Mdl} is the @code{ClassificationDiscriminant} object to
  ...
  methods (Access = public)
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {CompactClassificationDiscriminant} {@var{n} =} nLinearCoeffs (@var{obj})
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{n} =} nLinearCoeffs (@var{obj}, @var{delta})
    ##
    ...
    function n = nLinearCoeffs (this, delta)
      ...
      if (! (isnumeric (delta) && isreal (delta)))
        error (strcat ("CompactClassificationDiscriminant.nLinearCoeffs:", ...
                       " DELTA must be a real numeric value."));
      endif
    ...
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{L} =} loss (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{L} =} loss (@var{obj}, @var{Tbl})
    ...
    function L = loss (this, X, Y, varargin)
      ...
      [gYidx, ~] = labelIndices (this.ClassNames, Y);
      for i = 1:n
        class_idx = gYidx(i);
        C(i, class_idx) = true;
      endfor
    ...
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{m} =} margin (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{m} =} margin (@var{obj}, @var{Tbl})
    ##
    ...
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{e} =} edge (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{e} =} edge (@var{obj}, @var{Tbl})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn  {CompactClassificationDiscriminant} {@var{M} =} mahal (@var{obj}, @var{X})
    ## @deftypefnx {CompactClassificationDiscriminant} {@var{M} =} mahal (@dots{}, @qcode{'ClassLabels'}, @var{labels})
    ##
    ...
    ## -*- texinfo -*-
    ## @deftypefn {CompactClassificationDiscriminant} {@var{lp} =} logp (@var{obj}, @var{X})
    ##
...
%! CMdl = compact (fitcdiscr (meas, species, 'DiscrimType', 'quadratic')); ...
%! CMdl.Gamma = 0.5;
%!error<CompactClassificationDiscriminant: cannot eliminate linear predictors in a quadratic discriminant.> ...
%! load fisheriris; ...
%! CMdl = compact (fitcdiscr (meas, species, 'DiscrimType', 'quadratic')); ...
%! CMdl.Delta = 0.5;
%!error<CompactClassificationDiscriminant: 'Delta' must be a nonnegative scalar.> ...
%! load fisheriris; ...
%! CMdl = compact (fitcdiscr (meas, species)); CMdl.Delta = -1;
...
%!test
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species, 'Gamma', 0.5));
%! M = mahal (Mdl, meas(1:5,:));
...
%!test
%! load fisheriris
%! M1 = mahal (compact (fitcdiscr (meas, species)), meas(1:5,:));
%! Mdl = compact (fitcdiscr (meas, species, 'Prior', [0.6, 0.2, 0.2]));
...
%!error<CompactClassificationDiscriminant.mahal: X is empty.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! mahal (Mdl, [])
%!error<CompactClassificationDiscriminant.mahal: X must have the same number of predictors as the trained model.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! mahal (Mdl, ones (3, 2))
%!error<CompactClassificationDiscriminant.mahal: X must be a real numeric matrix.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! mahal (Mdl, {1, 2, 3, 4})
%!error<CompactClassificationDiscriminant.mahal: Name-Value arguments must be in pairs.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
...
%!error<CompactClassificationDiscriminant.mahal: every 'ClassLabels' entry must be one of ClassNames.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! mahal (Mdl, meas(1:2,:), 'ClassLabels', {'setosa'; 'nosuchspecies'})
%!error<CompactClassificationDiscriminant.logp: X is empty.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! logp (Mdl, [])
%!error<CompactClassificationDiscriminant.logp: X must have the same number of predictors as the trained model.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! logp (Mdl, ones (3, 2))
%!error<CompactClassificationDiscriminant.logp: X must be a real numeric matrix.> ...
%! load fisheriris
%! Mdl = compact (fitcdiscr (meas, species));
%! logp (Mdl, {1, 2, 3, 4})
