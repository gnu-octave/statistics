...
classdef RegressionKernel < PredictiveModel
  ...
  methods (Access = public)
    ...
    ## @deftypefnx {RegressionKernel} {@var{l} =} loss (@var{obj}, @var{Tbl}, @var{ResponseVarName})
    ## @deftypefnx {RegressionKernel} {@var{l} =} loss (@var{obj}, @var{Tbl})
...
%!               sort ({'Epsilon'; 'BoxConstraint'; 'ResponseTransform'; ...
%!                      'PredictorNames'; 'CategoricalPredictors'; ...
%!                      'ResponseName'; 'ExpandedPredictorNames'; ...
%!                      'NumExpansionDimensions'; 'FittedLoss'; 'Lambda'; ...
%!                      'ModelParameters'; 'Regularization'; 'KernelScale'; ...
%!                      'Learner'; 'Mu'; 'Sigma'}));
...
%!test
%! load fisheriris
%! Mdl = fitrkernel (meas(:,2:4), meas(:,1));
